...
function Coin({ selectedSide, flipCoin, wallet,result }) {
  ...
  const handleFlipCoin = () => {
    ...
    setTimeout(() => {
      const result = flipCoin(); // This should return 'Heads' or 'Tails'
  ...
  return (
    <div>
      <div>
        ...
        <img
          src={`/${result|| selectedSide}.jpg`} // Show the flipped side if available, otherwise the selected side
